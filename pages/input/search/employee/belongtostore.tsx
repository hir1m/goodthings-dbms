...
const SearchEmployeeBelongToStore: NextPage<Props> = ({ userdata }) => {
  ...
  const handleClick = async (_: MouseEvent<HTMLButtonElement>) => {
    ...
    Router.push(`/view/employee/belongtostore?id=${id}`);
  };
      ...
      <Container>
        ...
        >
          <h3 className="text-center text-md-left">
            Get the number of employees belonging to a branch
          </h3>
        </Row>
      </Container>
...
SearchEmployeeBelongToStore.getInitialProps = async (ctx) => {
...
export default SearchEmployeeBelongToStore;
