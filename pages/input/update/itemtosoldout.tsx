...
const ItemToSoldout: NextPage<Props> = ({ userdata }) => {
  ...
  return (
    <div>
      ...
      <Container>
        ...
        >
          <h3 className="text-center text-md-left">Move item to soldout items</h3>
        </Row>
      </Container>
...
ItemToSoldout.getInitialProps = async (ctx) => {
