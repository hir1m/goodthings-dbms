...
const InsertAvaliableItem: NextPage<Props> = ({ userdata }) => {
  ...
  const handleClick = async (_: MouseEvent<HTMLButtonElement>) => {
    ...
    if (price.length >= 1 && !isFloat(price)) {
  ...
  return (
    <div>
      <Modal show={ok} centered>
        ...
        <Modal.Body>New item is added</Modal.Body>
        <Modal.Footer>
          <Button
            variant="primary"
            onClick={(_) => {
      ...
      <Container>
        ...
        >
          <h3 className="text-center text-md-left">Add a new item</h3>
        </Row>
      </Container>
      ...
      <Container>
        <Form>
          ...
          <Form.Group className={styles.form_group} as={Row} controlId="url">
            <Form.Label column xs="3">
              &nbsp;Item URL
            </Form.Label>
            <Col xs="9">
          ...
          <Form.Group className={styles.form_group} as={Row} controlId="bid">
            <Form.Label column xs="3">
              &nbsp;Branch ID
            </Form.Label>
            <Col xs="9">
          ...
          <Form.Group className={styles.form_group} as={Row} controlId="cid">
            <Form.Label column xs="3">
              &nbsp;Contract ID
            </Form.Label>
            <Col xs="9">
...
InsertAvaliableItem.getInitialProps = async (ctx) => {
...
export default InsertAvaliableItem;
