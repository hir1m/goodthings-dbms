...
const DeleteSoldoutItem: NextPage<Props> = ({ userdata }) => {
  ...
  return (
    <div>
      <Modal show={ok} centered>
        ...
        <Modal.Body>Item with id:{formData.id} is deleted</Modal.Body>
        <Modal.Footer>
          <Button
            variant="primary"
            onClick={(_) => {
      ...
      <Container>
        ...
        >
          <h3 className="text-center text-md-left">Delete an item</h3>
        </Row>
      </Container>
...
DeleteSoldoutItem.getInitialProps = async (ctx) => {
...
export default DeleteSoldoutItem;
